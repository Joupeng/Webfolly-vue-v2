          ...
          <div class="card_outside">
            ...
            <div class="card_inside">
              <div class="text_box">
                  ...
                  <div class="enter_game"><router-link :to="{ name: 'game_fakenews' }" @click="closeNav"><span :class="{ 'frontheader_menu-on': $route.name == 'game_fakenews' }">進入遊戲</span></router-link></div>
                </div>
              </div>
            </div>
        </div>
...
export default {
  ...
  data(){
    return{
            content:"現在資訊氾濫且易取得，為了讓大家更理解所謂的誘餌式標題跟假訊息內容，我們來點小測驗吧!就由吉祥物陪伴大家一起闖關，希望透過題目能擁有更高的辨識能力，不會被錯誤訊息所誤導。"
    }
  }
}
</script>