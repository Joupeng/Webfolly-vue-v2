<template>
  <div class="game_fakenews">
    ...
    <div class="black_background" id="black_background" :class="{'-on': isVisible, '-qs_hidden': isCharacterWalking}"></div>
      ...
      <div class="outside_container">
        ...
        <div class="container_qs">
          <div class="left_QA">
            ...
            <div class="inner_qs">
              <!-- <p class="content_qs" v-for="(item1, index) in questionText1" :key="index">-->
            ...
            <!-- 寫法2失敗 -->
            <!-- <button type="button" @click=" choose_answer(answer)">確認</button> -->
          </div>
          <div class="right_QA">
            <p class="title_qs">選項二</p>
            <div class="inner_qs">
              <!-- <p class="content_qs" v-for="(item2, index) in questionText2" :key="index">{{ item2.text }}</p> -->
  ...
  methods: {
    ...
    addScore(index, ans) {
      ...
      if (this.questionText1[this.questionNumber - 1].ans == ans || this.questionText2[this.questionNumber - 1].ans == ans) {
        ...
        console.log(ans);
        // this.questionText1[this.questionNumber - 1].choosed = true;
        // this.questionText2[this.questionNumber - 1].choosed = true;
        this.score += 25;

        // this.questionText1.choosed = true;
      } else {
        alert("答錯囉");
        // this.questionText1[this.questionNumber - 1].choosed = true;
        // this.questionText2[this.questionNumber - 1].choosed = true;
        // this.questionText2.choosed = true;
      }
    ...
    //   if ((this.questionText1[(this.questionNumber) - 1].choosed) || (this.questionText2[(this.questionNumber) - 1].choosed) == null){
