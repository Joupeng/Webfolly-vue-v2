<template>
    ...
    <div class="outside_box">
            <div class="title_qa"><p>捐款FAQ</p></div>
                    ...
                    <li v-for="(item,index) in qa_items" class="list_qa" :key="index">
                        <div class="qs_content">
                            <div class="qs">Q{{ index +1 }}.{{ item.qs }}</div>
                                <button type="button" class="qa_button" @click="downSlide(index)" :class="{'-on' : BoxOpen && index == currnIndex}">
                        ...
                        <hr class="qs_hr" :class="{'-on' : BoxOpen && index == currnIndex}">
                        <div class="ans" :class="{'-on' : BoxOpen && index == currnIndex}">{{item.ans}}</div>
                    </li>
                </ul>
            </div>
    </div>
