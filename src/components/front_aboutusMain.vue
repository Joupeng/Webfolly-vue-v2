    ...
    <div class="description">
      ...
      <div class="purpose">
        ...
        <div class="text">
          ...
          <div class="para">
            在成為工程師的路上，我們七個人相遇了，我們發現我們都仰賴網路媒體獲取新知，但都無法信任媒體。我們決定用自己的力量改變，希望透過一個人人都可以輕鬆操作、兼具教育及趣味性的網站，讓媒體、平台、閱聽人意識到假訊息與誘餌式標題的嚴重性，還網路世界一個客觀公正的樣貌。我們相信，你我的每一次點擊，都是改變媒體環境的契機。
          </div>
        </div>
      </div>
